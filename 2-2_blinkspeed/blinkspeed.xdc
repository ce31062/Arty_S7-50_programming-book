...
create_clock -add -name sys_clk_pin -period 83.333 -waveform {0 5} [get_ports { CLK }];
...
## RGB LEDs
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { LED_RGB[2] }]; #IO_L23N_T3_FWE_B_15 Sch=led0_r # Red
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { LED_RGB[1] }]; #IO_L14N_T2_SRCC_15 Sch=led0_g # Green
set_property -dict { PACKAGE_PIN F15   IOSTANDARD LVCMOS33 } [get_ports { LED_RGB[0] }]; #IO_L13N_T2_MRCC_15 Sch=led0_b # Blue
...
## LEDs
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { Indicator[2] }]; #IO_L16N_T2_A27_15 Sch=led[2]
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { Indicator[1] }]; #IO_L17P_T2_A26_15 Sch=led[3]
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVCMOS33 } [get_ports { Indicator[0] }]; #IO_L17N_T2_A25_15 Sch=led[4]
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { Indicator[5] }]; #IO_L18P_T2_A24_15 Sch=led[5]

## Buttons
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { BTN[0] }]; #IO_L18N_T2_A23_15 Sch=btn[0] # BTN[0]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { RST }]; #IO_L19P_T3_A22_15 Sch=btn[1] # BTN[1]
